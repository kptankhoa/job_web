...
export const SPEECH_TO_TEXT_WS = 'ws://10.208.208.111:8080/speech2text-service';
...
export const PRE_SPEECH_BUFFER = NON_SPEECH_THRESHOLD - 10; // 10 - 10
...
export const MIN_SPEECH_LEN = 30; // 30 UNIT each 10ms = 300ms
